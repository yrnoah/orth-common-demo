import{j as n}from"./jsx-runtime-94f6e698.js";import{r as s}from"./index-8db94870.js";import{p as X}from"./styled-components.browser.esm-7ed061eb.js";import{M as A}from"./Modal-e047e149.js";import{t as K,p as o,c as V}from"./styled-components.browser.esm-6dd904cc.js";import{C as U}from"./Checkbox-be45dc65.js";import{u as Q}from"./useCurrent-3439251d.js";import{I as Y,a as D,b as Z,D as $}from"./IconTriangleRemindFill-fe005277.js";import{I as ee}from"./IconClose-bc396367.js";import"./_commonjsHelpers-042e6b4d.js";import"./emotion-unitless.esm-acc3a66a.js";import"./Portal-01fdeda0.js";import"./index-8ce4a492.js";import"./colors-1c1355f0.js";import"./IconChecked-147cf933.js";function f({open:e,title:t,children:r,icon:a,confirmIcon:i,cancelIcon:c,theme:l="standard",confirmText:I="Confirm",cancelText:B="Cancel",onConfirm:x,onCancel:g,onBGClick:C,disableConfirm:F,backgroundStyle:N,displayOnceText:R="Don’t show again",displayOnceStorageKey:u,headerStyle:O,contentStyle:_,footerStyle:H,showCloseButton:pe,...P}){const y=Q(x),{colors:h}=K(),[j,G]=s.useState(!1),S=!!u&&!!localStorage.getItem(u),z=e&&!S;s.useEffect(()=>{var v;e&&S&&((v=y.current)==null||v.call(y))},[e,S,y]);const k=()=>!!u&&j&&localStorage.setItem(u,"true"),J=()=>{k(),x==null||x()},L=()=>{k(),g==null||g()},W=()=>{k(),C==null||C()},w=typeof a=="string"?{info:n.jsx(Y,{color:h.elementsHintPlain}),warning:n.jsx(D,{color:h.elementsHintWarning}),error:n.jsx(Z,{color:h.elementsHintDanger}),dangerous:n.jsx(D,{color:h.elementsHintDanger})}[a]:a;return n.jsx(A,{open:z,onBGClick:W,backgroundStyle:{background:h.filterShade200,backdropFilter:"blur(2px)",...N},children:n.jsxs(de,{...P,children:[n.jsxs(le,{style:O,children:[n.jsxs(te,{children:[!!w&&n.jsx(ne,{children:w}),n.jsx("span",{children:t})]}),n.jsx(re,{onClick:g,children:n.jsx(ee,{})})]}),n.jsx(oe,{style:_,children:r}),n.jsxs(se,{style:H,children:[n.jsx(ie,{children:!!u&&n.jsxs(ae,{children:[n.jsx(U,{size:14,checked:j,onChange:()=>G(!j)}),R]})}),n.jsxs(ce,{children:[n.jsxs(M,{onClick:L,children:[c,n.jsx("span",{children:B})]}),n.jsxs(M,{onClick:J,$type:l,disabled:F,children:[i,n.jsx("span",{children:I})]})]})]})]})})}const p=o.div`
  ${e=>e.theme.flex.row}
...
}`,...(E=(q=b.parameters)==null?void 0:q.docs)==null?void 0:E.source}}};const Me=["ConfirmModal"];export{b as ConfirmModal,Me as __namedExportsOrder,De as default};
//# sourceMappingURL=ConfirmModal.stories-a2edd406.js.map
