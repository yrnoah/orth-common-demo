import{j as r}from"./jsx-runtime-94f6e698.js";import{r as u}from"./index-8db94870.js";import{f as h,p as X,c as a}from"./styled-components.browser.esm-6dd904cc.js";import{P as q,d as N}from"./Portal-01fdeda0.js";import{c as V}from"./unstated-next-d5bc192c.js";import{u as T}from"./useCurrent-3439251d.js";import"./_commonjsHelpers-042e6b4d.js";import"./emotion-unitless.esm-acc3a66a.js";import"./index-8ce4a492.js";const d=400;function E(e={duration:d,initialStage:"none"}){const[t,o]=u.useState(e.initialStage),n=T(e.onStageChange);u.useEffect(()=>{if(t==="leaving"){const i=setTimeout(()=>{o("none")},e.duration);return()=>clearTimeout(i)}if(t==="entering"){const i=setTimeout(()=>{o(l=>l==="entering"?"entered":l)},e.duration);return()=>clearTimeout(i)}n.current&&n.current(t)},[t,n,e.duration]);const s=u.useCallback(i=>{if(typeof i=="function")return o(i);o(l=>l==="none"&&i==="leaving"?"none":i)},[]);return{animatingStage:t,onSetAnimatingStage:s}}const k=V(E),R=k.Provider,$=k.useContainer,S=u.forwardRef((e,t)=>{if(!e.children)throw new Error("Please set drawer content.");return r.jsx(R,{initialState:{duration:(e==null?void 0:e.duration)||d,initialStage:e.initialStage||"none",onStageChange:e.onStageChange},children:r.jsx(B,{...e,ref:t})})}),B=u.forwardRef((e,t)=>{const{size:o="max-content",children:n,wrapperStyles:s,duration:i,position:l="right",portalID:A=N}=e,{onSetAnimatingStage:m,animatingStage:c}=$(),F=c!=="none",g=l==="right"||l==="left",Y=g?o:void 0,I=g?void 0:o,P=c==="entering"||c==="entered";return u.useImperativeHandle(t,()=>({open(){m("entering")},close(){m("leaving")},toggle(){let b=!1,w=c;switch(c){default:case"entering":case"entered":w="leaving";break;case"leaving":case"none":b=!0,w="entering";break}return m(w),b}}),[m,c]),!F||g&&!(o||s!=null&&s.width)||!g&&!(o||s!=null&&s.height)?null:r.jsx(q,{id:A,children:r.jsx(G,{style:{...s||{},width:Y,height:I},position:l,duration:i||d,active:P,children:n})})}),z=u.memo(S),O=h`
...
}`,...(j=(C=p.parameters)==null?void 0:C.docs)==null?void 0:j.source}}};const oe=["Drawer","DrawerWidthContent"];export{f as Drawer,p as DrawerWidthContent,oe as __namedExportsOrder,ae as default};
//# sourceMappingURL=Drawer.stories-a3b9748d.js.map
