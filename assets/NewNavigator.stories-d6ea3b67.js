import{j as t}from"./jsx-runtime-94f6e698.js";import{r as x}from"./index-8db94870.js";import{s as i,A as z,X as N}from"./styled-components.browser.esm-6007d051.js";import{r as k}from"./index-8ce4a492.js";import{f as R}from"./commons-95cc4cba.js";import{t as T,s as Y}from"./typography-46bf24ce.js";import{u as A}from"./useEffectOnce-29e89586.js";import{u as D}from"./useClickAway-7b3ab22c.js";import{D as K}from"./DmIcon12Right-630a0046.js";import{D as E}from"./DmIconLargeSsp-4794a515.js";import{D as X,I as G,a as J,b as Q,c as Z}from"./IconTreeToTop-2ca854a2.js";import"./_commonjsHelpers-042e6b4d.js";import"./util-051783c3.js";var f=(e=>(e[e.Empty=-2]="Empty",e[e.Title=-1]="Title",e))(f||{}),M=(e=>(e[e.Empty=-1]="Empty",e))(M||{});const B=x.createContext({currentSelectedItem:-1,currentEditItem:-2,setCurrentSelectedItem:()=>{},setCurrentEditItem:()=>{},handleRename:()=>()=>{}}),H=()=>x.useContext(B),ee=i.div`
  width: 100%;
  height: 52px;
...
`;i.div`
  overflow: hidden;
`;const le=22;function _({id:e,leaves:r,layer:n=1,...o}){const{currentEditItem:p,setCurrentEditItem:m,currentSelectedItem:l,setCurrentSelectedItem:s,handleRename:u}=H(),[h,g]=x.useState(!1),c=!!(r!=null&&r.length);return t.jsxs(ie,{selected:l===e,children:[t.jsx(ue,{className:l===e?"selected":"",expand:h,setExpand:g,...o,left:n*le,editing:p===e,hasChild:c,onClick:()=>{s==null||s(e)},onDoubleClick:()=>m==null?void 0:m(e),handleRename:u==null?void 0:u(e)}),h&&(r==null?void 0:r.map(({type:a,item:d,children:y})=>t.jsx(_,{...d,type:a,leaves:y,layer:n+1},d.id)))]})}function ue({className:e,expand:r,setExpand:n,left:o,hasChild:p,type:m,icon:l,name:s,editing:u,onClick:h,onDoubleClick:g,handleRename:c}){const a=x.useRef(null);return A(()=>{var d,y;u&&((d=a.current)==null||d.focus(),(y=a.current)==null||y.select())}),D(a,()=>{u&&a.current&&(c==null||c(a.current.value))}),t.jsxs(ae,{className:e,left:o+16,onClick:h,children:[p&&t.jsx(oe,{$rotate:r,onClick:()=>n(!r),children:t.jsx(K,{width:10,height:10})}),t.jsx(W,{type:m,icon:l}),u?t.jsx(ne,{ref:a,defaultValue:s,onKeyUp:d=>{switch(d.key){case"Enter":u&&a.current&&(c==null||c(a.current.value));return;case"Escape":u&&(c==null||c(s));return;default:return}}}):t.jsx(re,{onDoubleClick:g,children:s})]})}function W({type:e,icon:r}){const{colors:n}=N();return t.jsxs(se,{children:[!!r&&r,!r&&e==="group"&&t.jsx(E,{width:20,height:12,color:n.Neutral_400}),!r&&e==="ssp"&&t.jsx(E,{width:20,height:12,color:n.Neutral_400}),!r&&e==="fmu"&&t.jsx(X,{width:21,height:14,color:n.Neutral_400}),!r&&e==="input"&&t.jsx(G,{width:16,height:16,color:n.Neutral_400}),!r&&e==="output"&&t.jsx(J,{width:16,height:16,color:n.Neutral_400})]})}const S=({name:e,icon:r,handleRenameSSP:n})=>{const o=x.useRef(null),{currentEditItem:p,setCurrentEditItem:m}=H();return A(()=>{var l,s;p===f.Title&&((l=o.current)==null||l.focus(),(s=o.current)==null||s.select())}),D(o,()=>{var l;p===f.Title&&n(((l=o.current)==null?void 0:l.value)??"NamingError")}),t.jsxs(ee,{onDoubleClick:()=>m==null?void 0:m(f.Title),children:[t.jsx(W,{type:"ssp",icon:r}),p===f.Title?t.jsx(L,{ref:o,defaultValue:e,onKeyUp:l=>{var s,u;switch(l.key){case"Enter":p===f.Title&&((s=o.current)!=null&&s.value)&&n((u=o.current)==null?void 0:u.value);return;case"Escape":p===f.Title&&n(e);return;default:return}}}):t.jsx(te,{children:e})]})};try{_.displayName="Item",_.__docgenInfo={description:"",displayName:"Item",props:{id:{defaultValue:null,description:"",name:"id",required:!0,type:{name:"SystemIdType"}},name:{defaultValue:null,description:"",name:"name",required:!0,type:{name:"string"}},layer:{defaultValue:{value:"1"},description:"",name:"layer",required:!1,type:{name:"number"}},type:{defaultValue:null,description:"",name:"type",required:!0,type:{name:"enum",value:[{value:'"input"'},{value:'"output"'},{value:'"group"'},{value:'"ssp"'},{value:'"fmu"'}]}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},leaves:{defaultValue:null,description:"",name:"leaves",required:!1,type:{name:"ITreeItem[]"}}}}}catch{}try{S.displayName="Title",S.__docgenInfo={description:"",displayName:"Title",props:{name:{defaultValue:null,description:"",name:"name",required:!0,type:{name:"string"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},handleRenameSSP:{defaultValue:null,description:"",name:"handleRenameSSP",required:!0,type:{name:"(title: string) => void"}}}}}catch{}function w({hidden:e,initialHide:r,sspTitle:n,data:o,editTitle:p,handleRenameSSP:m,handleRenameItem:l,currentSelectedItem:s,setCurrentSelectedItem:u,showBackIcon:h,backIconLabel:g,handleClickBackButton:c,style:a}){const[d,y]=x.useState(r),[F,j]=x.useState(p?f.Title:f.Empty),P=x.useRef(null),{colors:O}=N(),C=()=>j(f.Empty);return t.jsxs(B.Provider,{value:{currentEditItem:F,setCurrentEditItem:j,currentSelectedItem:s,setCurrentSelectedItem:u,handleRename:I=>v=>{C(),l(I)(v)}},children:[k.createPortal(t.jsx(ce,{revert:d,onClick:()=>y(!d),hidden:e,children:t.jsx(Q,{width:12,height:12,color:O.Neutral_300})}),document.body),!e&&h&&k.createPortal(t.jsx(me,{onClick:c,style:{top:d?"calc(50% - 10px)":a==null?void 0:a.top,left:d?"50px":"20%"},children:t.jsxs(fe,{hoverable:d,children:[t.jsx(he,{children:g}),t.jsx(xe,{})]})}),document.body),!e&&t.jsxs(pe,{hide:d,style:a,ref:P,children:[t.jsx(S,{name:n,handleRenameSSP:I=>{m(I),C()}}),t.jsx(de,{children:o.map(({type:I,item:v,children:U},ve)=>t.jsx(_,{id:v.id,type:I,name:v.name,leaves:U},v.id))})]})]})}const de=i.div`
  overflow-y: scroll;
...
`,Ie=[{type:"ssp",item:{id:1,name:"MySystem",system_type:2,description:"A",version:"2.0"},children:[{type:"fmu",item:{id:101,name:"FMU 1",system_type:3,description:"A",version:"2.0"}},{type:"fmu",item:{id:102,name:"FMU 2",system_type:3,description:"A",version:"2.0"}}]},{type:"group",item:{id:2,name:"MySystem",system_type:2,description:"A",version:"2.0"}}];var $,V,q;b.parameters={...b.parameters,docs:{...($=b.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: () => <Component />
}`,...(q=(V=b.parameters)==null?void 0:V.docs)==null?void 0:q.source}}};const De=["FileTree"];export{b as FileTree,De as __namedExportsOrder,Ae as default};
//# sourceMappingURL=NewNavigator.stories-d6ea3b67.js.map
