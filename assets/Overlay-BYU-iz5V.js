import{r as l,j as o,d as c,l as g}from"./iframe-BY0Ds_wu.js";import{u as b}from"./useCurrent-DG4O13e4.js";import{S as v}from"./IconCheckSmall-XAk7e1-B.js";const k=136,$=24,C={width:k,height:$},y=l.memo(e=>{const{options:i,disabled:f,onSelect:r,resetText:a,selected:d,visible:p,...h}=e,n=l.useRef({}),s=b(d);return l.useEffect(()=>{p&&s.current&&n.current[s.current]&&n.current[s.current]?.scrollIntoView()},[s,n,p]),!i||f?null:o.jsxs(w,{...h,onScroll:t=>{t.stopPropagation(),t.preventDefault()},children:[!!a&&o.jsx(u,{onClick:()=>{r&&r(null)},children:a}),i.map(t=>o.jsxs(u,{ref:m=>{n.current[t.key]=m},$active:t.key===d,onClick:()=>{r&&r(t)},children:[o.jsx(x,{}),o.jsx("span",{children:t.text??t.key})]},t.key))]})}),x=c(v)`
  width: 16px;
  height: 16px;
