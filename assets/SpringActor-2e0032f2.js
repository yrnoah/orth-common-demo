import{j as o}from"./jsx-runtime-94f6e698.js";import{u as m,a as u}from"./react-spring-web.esm-788c8f7b.js";import{r as g}from"./index-8db94870.js";import{p as y}from"./styled-components.browser.esm-8c817f58.js";import{c as S}from"./common-d4e29412.js";import{S as A}from"./Dynamic-993557e0.js";const a=g.forwardRef(({children:e,init:s,to:i,config:p=S,delay:n=0,...l},d)=>{const[c,f]=m(()=>({from:s,to:i,onStart:({value:t},r)=>{t.display==="none"&&r.start({display:"flex"})},onRest:({value:t},r)=>{t.opacity===0&&r.start({display:"none"})},delay:n,config:p}),[i,n]);return o.jsx(A,{value:{controller:f},children:o.jsx(x,{...l,style:c,ref:d,children:e})})});a.displayName="SpringActor";const x=y(u.div)`
  position: absolute;
  top: 0;
  left: 0;
  width: fit-content;
...
//# sourceMappingURL=SpringActor-2e0032f2.js.map
