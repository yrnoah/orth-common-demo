import{j as l}from"./jsx-runtime-94f6e698.js";import{r as b}from"./index-8db94870.js";import{p as B,c as _}from"./styled-components.browser.esm-8c817f58.js";import{h as E}from"./colors-0fffe0c4.js";import"./_commonjsHelpers-042e6b4d.js";const c=b.forwardRef((e,a)=>{const{size:t=10,borderWidth:s=0,width:u,defaultChecked:y=!1,checked:p,disabled:i=!1,onChange:f,style:r,padding:C=3,minPadding:w=3,...z}=e,[D,N]=b.useState(y),x=typeof p=="boolean"?p:D,m=b.useMemo(()=>{const d=Math.max(C,w),n=s||parseFloat(`${r==null?void 0:r.borderWidth}`)||0,F=t+d*2+n,M=u||O(t)+d*2+n,A=d+t*.5+n;return{...r||{},padding:d,borderRadius:A,width:Math.max(M,F),borderWidth:Math.max(n,0)}},[r,C,w,t,u,s]);if(t<=0)return null;const j=m.width-t-m.borderWidth-m.padding*2;return l.jsx(v,{type:"button",...z,ref:a,active:x,size:t,translateX:j,disabled:i,style:m,onClick:d=>{if(i)return;const n=!x;f&&f(n,d),N(n)},children:l.jsx(o,{})})});b.memo(c);const o=B.div({}),v=B.button`
  ...
  ${({duration:e,transitionTiming:a})=>_`
  ...
  ${({active:e,theme:a,disabled:t,translateX:s,activeBorderColor:u,activeColor:y,activeBackgroundColor:p})=>{if(e){if(t)return _`
          ${o} {
            transform: translateX(${s}px);
          }
        `;let i=u,f=y||a.colors.Oxfordblue_200;if(!i){const r=E(a.colors.Oxfordblue_500);i=r?`rgba(${r.r},${r.g},${r.b},0.2)`:a.colors.Oxfordblue_500}return _`
        border-color: ${i};
...
@description container width, if not set, width = size * 2.6 + padding + border-size`,name:"width",required:!1,type:{name:"number"}},onChange:{defaultValue:null,description:"",name:"onChange",required:!1,type:{name:"((checked: boolean, event: MouseEvent<HTMLButtonElement, MouseEvent>) => void)"}}}}}catch{}try{o.displayName="Dot",o.__docgenInfo={description:"",displayName:"Dot",props:{theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"DefaultTheme"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"void | WebTarget"}},forwardedAs:{defaultValue:null,description:"",name:"forwardedAs",required:!1,type:{name:"void | WebTarget"}}}}}catch{}try{v.displayName="Wrapper",v.__docgenInfo={description:"",displayName:"Wrapper",props:{theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"DefaultTheme"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"void | WebTarget"}},forwardedAs:{defaultValue:null,description:"",name:"forwardedAs",required:!1,type:{name:"void | WebTarget"}}}}}catch{}const G={title:"PAAS/Switch",tags:["autodocs"],component:c};function T({...e}){return l.jsxs(l.Fragment,{children:[l.jsx(c,{...e}),!!e.id&&l.jsx("label",{htmlFor:e.id,style:{marginLeft:10},children:e.id})]})}const h={render:T,args:{size:10,padding:3,transitionTiming:"linear"}},g={render:T,args:{size:20,padding:5,defaultChecked:!0,activeColor:"orange",transitionTiming:"ease-out",id:"test switch",onChange:e=>console.info("change checked to: ",e)}};var k,$,V;h.parameters={...h.parameters,docs:{...(k=h.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: SwitchStory,
  args: {
    size: 10,
    padding: 3,
...
//# sourceMappingURL=Switch.stories-91d577d9.js.map
