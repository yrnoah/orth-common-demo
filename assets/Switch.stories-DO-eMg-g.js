import{r as y,j as a,d as x,l as w,h as E}from"./iframe-D12yBJYT.js";import"./preload-helper-D9Z9MdNV.js";const g=e=>{const{size:t=10,borderWidth:l=0,width:d,defaultChecked:b=!1,checked:u,disabled:p=!1,onChange:o,style:s,padding:r=3,minPadding:C=3,...$}=e,[S,q]=y.useState(b),k=typeof u=="boolean"?u:S,f=y.useMemo(()=>{const i=Math.max(r,C),n=l||parseFloat(`${s?.borderWidth}`)||0,B=t+i*2+n,_=d||M(t)+i*2+n,z=i+t*.5+n;return{...s||{},padding:i,borderRadius:z,width:Math.max(_,B),borderWidth:Math.max(n,0)}},[s,r,C,t,d,l]);if(t<=0)return null;const v=f.width-t-f.borderWidth-f.padding*2;return a.jsx(F,{type:"button",...$,active:k,size:t,translateX:v,disabled:p,style:f,onClick:i=>{if(p)return;const n=!k;o&&o(n,i),q(n)},children:a.jsx(c,{})})};y.memo(g);const c=x.div({}),F=x.button`
  ...
  ${({active:e,theme:t,disabled:l,translateX:d,activeBorderColor:b,activeColor:u,activeBackgroundColor:p})=>{if(e){if(l)return w`
        ...
        `;let o=b,s=u||t.colors.brandColor.Primary7;if(!o){const r=E(t.colors.Oxfordblue_500);o=r?`rgba(${r.r},${r.g},${r.b},0.2)`:t.colors.Oxfordblue_500}return w`
        border-color: ${o};
