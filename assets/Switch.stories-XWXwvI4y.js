import{r as y,j as a,d as x,l as w,h as E}from"./iframe-AucjWJ36.js";import"./preload-helper-D9Z9MdNV.js";const g=e=>{const{size:t=10,borderWidth:l=0,width:d,defaultChecked:b=!1,checked:u,disabled:p=!1,onChange:o,style:s,padding:n=3,minPadding:C=3,...$}=e,[S,q]=y.useState(b),k=typeof u=="boolean"?u:S,f=y.useMemo(()=>{const i=Math.max(n,C),r=l||parseFloat(`${s?.borderWidth}`)||0,B=t+i*2+r,_=d||M(t)+i*2+r,z=i+t*.5+r;return{...s||{},padding:i,borderRadius:z,width:Math.max(_,B),borderWidth:Math.max(r,0)}},[s,n,C,t,d,l]);if(t<=0)return null;const v=f.width-t-f.borderWidth-f.padding*2;return a.jsx(F,{type:"button",...$,active:k,size:t,translateX:v,disabled:p,style:f,onClick:i=>{if(p)return;const r=!k;o&&o(r,i),q(r)},children:a.jsx(c,{})})};y.memo(g);const c=x.div({}),F=x.button`
