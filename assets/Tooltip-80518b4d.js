...
`;try{b.displayName="Tooltip",b.__docgenInfo={description:"",displayName:"Tooltip",props:{tooltip:{defaultValue:null,description:"",name:"tooltip",required:!1,type:{name:"ReactNode"}},parent:{defaultValue:null,description:"",name:"parent",required:!0,type:{name:"RefObject<HTMLButtonElement | null>"}},tooltipPosition:{defaultValue:{value:"bottom"},description:"",name:"tooltipPosition",required:!0,type:{name:"enum",value:[{value:'"top"'},{value:'"bottom"'}]}},show:{defaultValue:null,description:"",name:"show",required:!1,type:{name:"boolean"}},style:{defaultValue:null,description:"",name:"style",required:!1,type:{name:"CSSProperties"}}}}}catch{}export{b as T};
//# sourceMappingURL=Tooltip-80518b4d.js.map
