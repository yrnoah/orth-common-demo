import{j as e}from"./jsx-runtime-94f6e698.js";import{p as x}from"./styled-components.browser.esm-8c817f58.js";import{I as f}from"./Icon12Warning-8aed6788.js";import{T as m}from"./Tooltip-198036bf.js";import"./index-8db94870.js";import"./_commonjsHelpers-042e6b4d.js";import"./index-8ce4a492.js";const C={title:"PAAS/Tooltip"},g=["top","bottom","left","right"],$=["start","center","end"],j=t=>e.jsx(b,{children:g.map((r,h)=>$.map((s,l)=>e.jsx(m,{position:r,align:s,gap:10,text:l%2===0?e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4},children:[e.jsx(f,{style:{flex:"none"},width:12,height:12}),e.jsxs("span",{style:{flex:"none"},children:[r," ",s]})]}):`${r} ${s}`,children:v[h][l]},r+s)))}),p=j.bind({}),n=88,i=32,b=x.div`
  position: relative;
...
//# sourceMappingURL=Tooltip.stories-45124b53.js.map
