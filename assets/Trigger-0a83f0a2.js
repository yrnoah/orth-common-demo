import{j as o}from"./jsx-runtime-94f6e698.js";import{r as f}from"./index-8db94870.js";import{p as s,c as y}from"./styled-components.browser.esm-655d472d.js";import{I as w}from"./IconArrowSm-8c383373.js";const h=f.forwardRef((e,t)=>{const{$text:n,$placeholder:c,children:r,$open:d,...l}=e,[x,_]=f.useState(()=>!!d),u=typeof d=="boolean"?d:x,$=!n&&!r&&!!c;return o.jsxs(p,{...l,$open:u,onClick:b=>{var m;(m=l.onClick)==null||m.call(l,b),_(!u)},ref:t,children:[$&&o.jsx(a,{isPlaceholder:!0,children:c}),!!n&&o.jsx(a,{children:n}),!n&&typeof r=="string"&&o.jsx(a,{children:r}),typeof r!="string"&&r,o.jsx(i,{})]})}),T={type:"button",role:"select"},p=s.button.attrs(T)`
  ${e=>e.theme.flex.row}
  ${e=>e.theme.ellipsis}
...
//# sourceMappingURL=Trigger-0a83f0a2.js.map
