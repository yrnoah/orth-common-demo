import{r as x,j as r,d as n,l as c}from"./iframe-BY0Ds_wu.js";import{S as f}from"./IconArrowSm-GvQv39wR.js";const $=e=>{const{$text:t,$placeholder:l,children:o,$open:i,...a}=e,[h,u]=x.useState(()=>!!i),d=typeof i=="boolean"?i:h,m=!t&&!o&&!!l;return r.jsxs(w,{...a,$open:d,onClick:g=>{a.onClick?.(g),u(!d)},children:[m&&r.jsx(s,{isPlaceholder:!0,children:l}),!!t&&r.jsx(s,{children:t}),!t&&typeof o=="string"&&r.jsx(s,{children:o}),typeof o!="string"&&o,r.jsx(p,{})]})},b={type:"button",role:"select"},w=n.button.attrs(b)`
  ${e=>e.theme.flex.row}
  ${e=>e.theme.ellipsis}
