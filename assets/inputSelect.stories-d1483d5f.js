import{j as o}from"./jsx-runtime-94f6e698.js";import{c as a,s as j}from"./colors-1c1355f0.js";import{r as p,R}from"./index-8db94870.js";import{p as D}from"./styled-components.browser.esm-7ed061eb.js";import{p as m}from"./styled-components.browser.esm-6dd904cc.js";import{f as O}from"./fonts-d9df4e72.js";import{B as T}from"./Dropdown-02d796e2.js";import{I as B}from"./IconArrowSm-8c383373.js";import"./_commonjsHelpers-042e6b4d.js";import"./emotion-unitless.esm-acc3a66a.js";import"./Portal-01fdeda0.js";import"./index-8ce4a492.js";import"./useCurrent-3439251d.js";import"./useMeasure-2fb4c371.js";const y=m(B)`
  display: flex;
  align-items: center;
...
`;try{y.displayName="DropdownButton",y.__docgenInfo={description:"",displayName:"DropdownButton",props:{theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"DefaultTheme"}},as:{defaultValue:null,description:"",name:"as",required:!1,type:{name:"void | WebTarget"}},forwardedAs:{defaultValue:null,description:"",name:"forwardedAs",required:!1,type:{name:"void | WebTarget"}}}}}catch{}function F(e,n,r=!0){return r?e.filter(n):e}const z=136,E=24,N={width:z,height:E};function c({inputAttrs:e,defaultVisible:n,options:r,optionStyle:x,size:l="small",value:f,setValue:i,enableFilterOption:h,wrapperStyle:_,...I}){const[s,g]=p.useState(n??!1),[w,V]=p.useState(!1),[b,$]=p.useState(N),k=p.useMemo(()=>o.jsx(o.Fragment,{children:!!r&&F(r,t=>h?t.includes(f??""):!0,h).map((t,d)=>o.jsx(P,{$size:l,onClick:()=>{i&&i(t),g(!1)},style:{...x},children:t},d))}),[h,x,r,i,l,f]);return o.jsx(T,{visible:s,overlay:k,overlayContainerStyle:{background:"#fff",borderRadius:"4px",overflow:"hidden",boxShadow:j.hardShadow,width:b.width},...I,onVisibleChange:t=>g(t),children:o.jsxs(H,{ref:t=>{if(!t)return;const d=t.getBoundingClientRect(),v={width:d.width,height:d.height};(b.width!==v.width||b.height!==v.height)&&$(v)},style:{borderColor:w||s?a.textInput.link:void 0,backgroundColor:w||s?"#fff":void 0,padding:l==="small"?"1px 5px":"8px 5px",..._},children:[o.jsx(L,{onChange:t=>i==null?void 0:i(t.target.value),...e,value:f,onFocus:t=>{V(!0),e!=null&&e.onFocus&&e.onFocus(t)},onBlur:t=>{V(!1),e!=null&&e.onBlur&&e.onBlur(t)}}),o.jsx(y,{onClick:()=>g(!s),$size:l,style:{position:"absolute",right:6}})]})})}const L=m.input`
  position: relative;
  border: none;
  outline: none;
  height: 20px;
...
}`,...(C=(S=u.parameters)==null?void 0:S.docs)==null?void 0:C.source}}};const ae=["InputOption"];export{u as InputOption,ae as __namedExportsOrder,ne as default};
//# sourceMappingURL=inputSelect.stories-d1483d5f.js.map
